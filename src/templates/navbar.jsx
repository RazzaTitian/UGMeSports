...
const LoginButton = ({ onScroll, children }) => {
  return (
    <button
      ...
      className={
        (onScroll > 200
          ? "lg:text-teal-secondary lg:outline-teal-secondary "
          : "lg:text-white lg:outline-white ") +
        oxygen +
...
const DropdownComponent = ({
  ...
  return (
    ...
    >
      ...
      <DropdownMenu variant="flat">{children}</DropdownMenu>
    </Dropdown>
  );
};
    ...
    >
      ...
      <NavbarContent className="hidden lg:flex gap-0" justify="end">
        ...
        <NavbarItem>
          <Dropdown
            radius="sm"
            onOpenChange={(isOpen) => setIsInitiativeOpen(isOpen)}
            placement="bottom-end"
          >
            <DropdownTrigger>
              <div
            ...
            <DropdownMenu variant="flat">
              <DropdownItem
                ...
                className={
                  oxygen +
                  "text-primary-dark data-[hover]:bg-teal-secondary/25 data-[hover]:text-teal-secondary data-[focus-visible=true]:outline-teal-secondary"
                }
              >
              ...
              >
                <span className="text-lg">PUBG Mobile</span>
              </DropdownItem>
              <DropdownItem
                key="shorelab-academy"
                href="/initiatives/shorelab-academy"
              ...
              >
                <span className="text-lg">Mobile Legends</span>
              </DropdownItem>
              <DropdownItem
                key="projects"
        ...
        <NavbarItem>
          ...
          >
            ...
            >
              <span className="text-lg">ShoreSnap</span>
            </DropdownItem>
            <DropdownItem
            ...
            >
              <span className="text-lg">ShoreLab Insight</span>
            </DropdownItem>
          </DropdownComponent>
        </NavbarItem>
        <NavbarItem>
          ...
          >
            ...
            >
              <span className="text-lg">Partnership</span>
            </DropdownItem>
            <DropdownItem
              key="career"
              href="#"
      ...
      <NavbarContent justify="end">
        <NavbarItem>
          <Link href="/login">
            <LoginButton onScroll={scrollPos} size="sm">
              Login
            </LoginButton>
          </Link>
        </NavbarItem>
      ...
      <NavbarMenu className={oxygen + "text-primary-dark p-0 gap-0 h-fit"}>
        ...
        <NavbarMenuItem className="flex flex-col">
          <button
            ...
            className="flex justify-between items-center w-full hover:bg-teal-secondary/75 hover:text-white transition-colors text-xl py-2 px-4 border-b border-slate-200"
          >
            <div>Initiatives</div>
            <FiChevronDown
              size={25}
          ...
          <Link
            ...
            href="/initiatives/shorelab-academy"
            className={
              (isInitiativeOpen ? "block " : "hidden ") +
              "w-full hover:bg-teal-secondary/75 hover:text-white transition-colors text-xl py-2 px-8 border-b border-slate-200"
            }
          >
            ShoreLab Academy
          </Link>
